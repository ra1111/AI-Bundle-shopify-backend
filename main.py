...
# Also mount without /api prefix for frontend compatibility (frontend calls /generation-progress/...)
app.include_router(generation_progress.router, tags=["generation-progress-no-prefix"])
